...
from jaxpint.constants import SECS_PER_DAY, TSUN, RAD_PER_MAS, KPC_TO_KM
...
class BinaryDDK(DelayComponent):
    ...
    def __call__(
        ...
        if self.pmra_name and self.pmdec_name and self.posepoch_name:
            ...
            dt_pos_days = (toa_data.tdb_int - posepoch_int) + (toa_data.tdb_frac - posepoch_frac)
