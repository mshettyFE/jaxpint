...
NIELL_LAT_BREAKS = jnp.array([0.0, 15.0, 30.0, 45.0, 60.0, 75.0, 90.0]) * (
    jnp.pi / 180.0
)
...
NIELL_A_AVG = (
    jnp.array(
        [1.2769934, 1.2769934, 1.2683230, 1.2465397, 1.2196049, 1.2045996, 1.2045996]
    )
    * 1e-3
)
...
NIELL_B_AVG = (
    jnp.array(
        [2.9153695, 2.9153695, 2.9152299, 2.9288445, 2.9022565, 2.9024912, 2.9024912]
    )
    * 1e-3
)
...
NIELL_C_AVG = (
    jnp.array(
        [62.610505, 62.610505, 62.837393, 63.721774, 63.824265, 64.258455, 64.258455]
    )
    * 1e-3
)
...
NIELL_A_AMP = (
    jnp.array([0.0, 0.0, 1.2709626, 2.6523662, 3.4000452, 4.1202191, 4.1202191]) * 1e-5
)
#: Hydrostatic amplitude coefficient b (Niell 1996, Table 3)
NIELL_B_AMP = (
    jnp.array([0.0, 0.0, 2.1414979, 3.0160779, 7.2562722, 11.723375, 11.723375]) * 1e-5
)
#: Hydrostatic amplitude coefficient c (Niell 1996, Table 3)
NIELL_C_AMP = (
    jnp.array([0.0, 0.0, 9.0128400, 4.3497037, 84.795348, 170.37206, 170.37206]) * 1e-5
)
...
NIELL_AW = (
    jnp.array(
        [5.8021897, 5.8021897, 5.6794847, 5.8118019, 5.9727542, 6.1641693, 6.1641693]
    )
    * 1e-4
)
...
NIELL_BW = (
    jnp.array(
        [1.4275268, 1.4275268, 1.5138625, 1.4572752, 1.5007428, 1.7599082, 1.7599082]
    )
    * 1e-3
)
...
NIELL_CW = (
    jnp.array(
        [4.3472961, 4.3472961, 4.6729510, 4.3908931, 4.4626982, 5.4736038, 5.4736038]
    )
    * 1e-2
)
